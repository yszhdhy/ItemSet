...
import com.xc.process.mapper.OaProcessTemplateMapper;
...
import com.xc.process.service.OaProcessTemplateService;
import com.xc.process.service.OaProcessTypeService;
...
public class OaProcessTemplateServiceImpl extends ServiceImpl<OaProcessTemplateMapper, ProcessTemplate> implements OaProcessTemplateService {
    ...
    public void publish(Long id) {
        ...
        //流程定义部署
        if(!StringUtils.isEmpty(processTemplate.getProcessDefinitionPath())) {  //判断路径 是否存在
